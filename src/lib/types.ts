...
export interface ReducableLinkedList extends LinkedList {
	readonly reduce: (fn: LinkedListReducer, initial: LinkedListNode) => LinkedListNode;
}
...
export type LinkedListReducer = (acc: LinkedListNode, x: LinkedListNode) => LinkedListNode;
